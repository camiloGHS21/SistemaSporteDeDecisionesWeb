...
const LoginHeader = () => {
  return (
    <div className="flex-grow-0 flex-shrink-0 w-full h-[136px] relative">
      <div className="flex justify-center items-start w-full absolute left-0 top-0">
        <svg
          width={48}
          height={48}
          viewBox="0 0 48 48"
      ...
      <div className="flex flex-col justify-start items-center w-full absolute left-0 top-[72px]">
      ...
      <div className="flex flex-col justify-start items-center w-full absolute left-0 top-[116px]">
