...
import { countries, indicators } from '../../data';
  ...
  return (
    <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-4 p-4 rounded-lg bg-white border border-gray-200">
      ...
      <button
        ...
        className="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 gap-2 px-4 py-3 rounded-md bg-[#1173d4]"
      >
